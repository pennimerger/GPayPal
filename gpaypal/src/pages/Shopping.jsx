...
const shield = getImageUrl("shopping/pp-blue-icon.png")
const credit = getImageUrl("shopping/credit-blue-icon.png")
const facebook = getImageUrl("shopping/facebook.png")
const twitter = getImageUrl("shopping/twitter_2.png")
const youtube = getImageUrl("shopping/You_tube_3.png")
const instagram = getImageUrl("shopping/instagram_5.png")
