...
const icon1 = getImageUrl("invoices/icon1.png")
const icon2 = getImageUrl("invoices/icon2.png")
const icon3 = getImageUrl("invoices/icon3.png")

function SendingInvoices() {
  return <>
