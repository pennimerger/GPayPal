...
const icon1 = getImageUrl("freelancers/icon1.png")
const icon2 = getImageUrl("freelancers/icon2.png")
const icon3 = getImageUrl("freelancers/icon3.png")
const icon4 = getImageUrl("freelancers/icon4.png")
