...
const buysell1 = getImageUrl('personal/buyandsellonebay_browser1.png');
const buysell2 = getImageUrl('personal/buyandsellonebay_browser2.png');
const buysell3 = getImageUrl('personal/buyandsellonebay_browser3.png');

function BuySellEbay() {
  return (<>
