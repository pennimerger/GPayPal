...
const sendpayments1 = getImageUrl('personal/sendpayments_browser1.png');
const sendpayments2 = getImageUrl('personal/sendpayments_browser2.png');
const sendpayments3 = getImageUrl('personal/sendpayments_browser3.png');
