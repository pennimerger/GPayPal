...
const requestMoney1 = getImageUrl('personal/requestmoney_browser1.png');
const requestMoney2 = getImageUrl('personal/requestmoney_browser2.png');
const requestMoney3 = getImageUrl('personal/requestmoney_browser3.png');
