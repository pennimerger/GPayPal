...
const buyers1 = getImageUrl('personal/buyonline_browser1.png');
const buyers2 = getImageUrl('personal/buyonline_browser2.png');
const buyers3 = getImageUrl('personal/buyonline_browser3.png');
